...
const MOCK_TIMELINE = [
    {
        id: "ev1",
        type: "ASSESSMENT", // Evaluación Periódica
        date: "Hoy, 09:30 AM",
        nurse: "Lucía F. (RN)",
        riskLevel: "HIGH",
        morseScore: 55,
    ...
    {
        id: "ev2",
        type: "INCIDENT", // Caída Real
        date: "Ayer, 21:15 PM",
        nurse: "Gabriel S. (LPN)",
        location: "Baño de la Habitación",
        severity: "MILD",
        action: "Traslado a cama, revisión sin fracturas. Aplicación de hielo en rodilla.",
        notes: "Resbaló con agua de la ducha mientras iba al inodoro. Se golpeó levemente."
    },
    {
        id: "ev3",
        type: "ASSESSMENT",
        date: "10 Octubre, 14:00 PM",
        nurse: "Lucía F. (RN)",
        riskLevel: "MODERATE",
        morseScore: 35,
        notes: "Evaluación de Ingreso. Muestra pasos inestables ocasionales."
    }
];
