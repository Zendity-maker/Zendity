    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-300">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between bg-white p-5 rounded-2xl shadow-sm border border-neutral-100 gap-4">
                ...
                <button className="flex items-center justify-center gap-2 bg-indigo-600 text-white px-4 py-2.5 rounded-xl text-sm font-bold hover:bg-indigo-700 transition shadow-sm w-full md:w-auto">
            ...
            {logs.length === 0 ? (
                <div className="bg-white border border-slate-100 rounded-3xl p-12 flex flex-col items-center justify-center text-center shadow-sm">
                    ...
                    <h3 className="text-lg font-bold text-slate-800">Sin Úlceras Activas</h3>
                    <p className="text-slate-500 font-medium max-w-sm mt-2">
                        El expediente dermatológico de este residente se encuentra limpio. No hay tratamientos de curación programados.
                    </p>
                </div>
            ) : (
                <>
